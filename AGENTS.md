...
An AI for Science starter kit for beginner researchers. Provides workflow templates, pre-trained model integrations, and interactive tutorials across drug discovery, materials science, climate, and genomics.
